...
function displayPicture(data){
    var $elem = "<table class=\"table table-striped table-bordered\"> <thead> <tr> <th>Id</th>  <th>Alias catégorie</th> <th>Surnom</th> <th>Session</th> <th>Machine utilisé</th> <th>Id_config</th> <th>Chemin du jpg</th> <th>Chemin du pdf</th><th>Date de création</th> <th>Date dernière modification</th> <th>Date prestashop</th> <th>Image</th> </tr>  </thead> <tbody> ";
    $.each(data, function (key, val) {
        $elem += "<tr>";
        $elem += "<td>" + val['id'] + "</td>";
        $elem += "<td>" + val['alias'] +"</td>";
