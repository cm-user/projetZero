...
use FaultyBundle\Entity\Supplier;
...
class SupplierController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $suppliers = $em->getRepository('FaultyBundle:Supplier')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('FaultyBundle\Form\SupplierType', $supplier);
    ...
    public function showAction(Supplier $supplier)
    {
        ...
        \Doctrine\Common\Util\Debug::dump($supplier);
    ...
    {
        $deleteForm = $this->createDeleteForm($supplier);
        $editForm = $this->createForm('FaultyBundle\Form\SupplierType', $supplier);
