        ...
        success: function (result) {
            ...
            $.each(result, function (key, val) {
                ...
                if(val['temps'] != undefined){
                    ...
                    $("#time_new_gravure").html("<h3> Temps estimé à " + val['temps'] +" minutes, fin prévue à " + newDateObj + "</h3><a><button class=\"btn btn-info\" onclick=\"actualize();\">Voir les paiements acceptés</button></a>");
                    ...
                    if(nom_categorie != old_nom_categorie){
                        if(compteur != 2){
                            ...
                            comtpeur_ligne = 1; //remet le compteur de ligne à 1 avant de passer à la prochaine catégorie
                        }
                        ...
                        $elem += "<table class=\"table\"> <thead> <tr> <th>Numéro</th> <th>Image</th> <th>Id Commande</th>  <th>Date de création</th> </tr> </thead> <tbody>";
